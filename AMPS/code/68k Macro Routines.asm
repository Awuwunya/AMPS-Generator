...
dModPorta	macro jump,loop,type
	...
	dPortamento	%macpfx%jump,%macpfx%loop,%macpfx%type
	dModulate	%macpfx%jump,%macpfx%loop,%macpfx%type
    endm
; ===========================================================================
; ---------------------------------------------------------------------------
...
.started
		...
		bne.s	.checkmod			; if there's still delay left, update vol and return
